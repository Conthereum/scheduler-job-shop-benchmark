...
from data_parsers import parser_fajsp, parser_fjsp, parser_fjsp_sdst, parser_jsp_fsp, parser_fjsp_conthereum
...
def load_job_shop_env(problem_instance: str, from_absolute_path=False) -> JobShop:
    ...
    elif '/fjsp_conthereum' in problem_instance:
        jobShopEnv = parser_fjsp_conthereum.parse_fjsp_conthereum(jobShopEnv, problem_instance, from_absolute_path)
    else:
